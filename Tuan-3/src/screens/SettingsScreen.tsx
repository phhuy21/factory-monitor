  ...
  return (
    <View style={styles.screen}>
      ...
      >
        ...
        {/* Nút kiểm tra còi hú khi khóa màn hình hoặc tắt app */}
        <TouchableOpacity
          style={styles.testAlarmButton}
          onPress={() => {
            notificationService.sendTestAlarm();
            Alert.alert(
              '⏱️ Đã kích hoạt hẹn giờ (3 giây)',
              'Bây giờ bạn hãy KHÓA MÀN HÌNH hoặc VUỐT TẮT APP ngay để kiểm tra còi hú và rung báo động!',
              [{ text: 'Đã hiểu' }]
            );
          }}
          activeOpacity={0.8}
        >
          <Text style={styles.testAlarmButtonText}>🚨 Thử Còi Hú Khi Khóa Màn Hình (3s)</Text>
        </TouchableOpacity>
